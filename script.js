...
async function guardarConfigRemota(configParcial) {
    try {
        // Google Apps Script no acepta POST con fetch por CORS
        // Usamos no-cors con form-encoded que sí funciona
        ...
        // no-cors no devuelve respuesta legible, pero el script igual ejecuta
