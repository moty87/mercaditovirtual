...
let zonasEnvio    = JSON.parse(localStorage.getItem('zonasEnvio')) || {
    ...
    departamentos: ['guaymallen','guaymallén', 'maipú', 'maipu'], // Departamentos habilitados
};
...
function esDepartamentoHabilitado(displayName) {
    ...
    const deps = zonasEnvio.departamentos || ['guaymallen', 'maipú', 'maipu'];
    return deps.some(d => dn.includes(d));
}
